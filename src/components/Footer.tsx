...
export const Footer = () => {
  return (
    <footer className="bg-ink text-canvas/60 py-20 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-16">
          <div className="col-span-1 md:col-span-2">
            <div className="mb-8">
                {/* Pass variant='light' so the 'lla' text is visible against dark footer */}
                <Logo className="w-48 h-20" variant="light" />
            </div>
            <p className="max-w-md leading-relaxed mb-8 font-serif text-lg font-light">
              "We don't just sell clothes; we curate wearable art." <br/>
          ...
          <div>
            <h3 className="text-white font-sans text-xs uppercase tracking-[0.2em] mb-8">Collection</h3>
          ...
          <div>
            <h3 className="text-white font-sans text-xs uppercase tracking-[0.2em] mb-8">Studio</h3>
            <ul className="space-y-4 font-serif text-lg">
        ...
        <div className="border-t border-white/10 pt-10 flex flex-col md:flex-row justify-between items-center text-sm font-sans tracking-wide opacity-60">
          <p>&copy; 2025 Kalla Handpainted Store.</p>
